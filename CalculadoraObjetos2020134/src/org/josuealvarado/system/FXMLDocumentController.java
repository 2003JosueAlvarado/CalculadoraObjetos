...
public class FXMLDocumentController implements Initializable {
    ...
    @FXML private Button btnSignoMas;
    @FXML private Button btnSignoMenos;
    @FXML private Button btnSignoPor;
    @FXML private Button btnSignoDivision;
    ...
    private void handleButtonAction(ActionEvent event) {
        if (event.getSource() == btnUno)
         ...
         if (txtPantalla.getText().length()<=0)
            ...
            }else if (event.getSource()==btnSignoMas){
            dato1 = Double.parseDouble(txtPantalla.getText());
            txtPantalla.clear();
            op = 1;
           
        }else if (event.getSource()==btnSignoMenos){
            dato1 = Double.parseDouble(txtPantalla.getText());
            txtPantalla.clear();
            op = 2;
        
        }else if (event.getSource()==btnSignoPor){
            dato1 = Double.parseDouble(txtPantalla.getText());
            txtPantalla.clear();
            op = 3;
            
        }else if (event.getSource()==btnSignoDivision){
            dato1 = Double.parseDouble(txtPantalla.getText());
            txtPantalla.clear();
            op = 4;
        }
